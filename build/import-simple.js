...
var importFiles = function (collectionName) { return __awaiter(void 0, void 0, void 0, function () {
...
var insertImages = function (collectionName) { return __awaiter(void 0, void 0, void 0, function () {
    var files, _i, files_1, file, item, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                console.log("Adding [".concat(item.type, "]: ").concat(item.name));
                return [4 /*yield*/, client.data
                        .creator()
                        .withClassName(collectionName)
                        .withProperties(item)
                        .withId((0, weaviate_ts_client_1.generateUuid5)(file.name))
                        .do()];
            case 2:
                result = _a.sent();
                _a.label = 3;
...
var insertAudio = function (collectionName) { return __awaiter(void 0, void 0, void 0, function () {
    var files, _i, files_2, file, item, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var insertVideo = function (collectionName) { return __awaiter(void 0, void 0, void 0, function () {
    var files, _i, files_3, file, item, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
